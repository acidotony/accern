...
address_space_spoke = ["10.10.8.0/22"]
...
subnets_spoke = {
  ...
  "acn-private-dev-eastus2-01-subnet" = {
...
key_vault_name = "acndevuse2kv01"
tenant_id    = "b5db11ac-8f37-4109-a146-5d7a302f5881"
object_id    = "bfcd94a6-8868-43d3-a3ca-3727505dd1a2"

storage_account_name = "acnappsharedevuse2stg01"



### ACR Values ####
acr_name             = "acndevuse2acr01"
acr_sku              = "Standard"
admin_enabled        = true
